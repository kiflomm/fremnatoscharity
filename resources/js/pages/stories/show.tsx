...
export default function StoryShow() {
  ...
  const submit = (e: React.FormEvent) => {
    e.preventDefault();
    post(route('public.stories.comment', { story: story.id }), {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-3xl mx-auto">
        <Link href={route('public.stories.index')} className="text-sm text-blue-600">← Back</Link>
        ...
        <div className="mt-6 flex items-center gap-4">
          <button
            onClick={() => router.post(route('public.stories.like', { story: story.id }))}
