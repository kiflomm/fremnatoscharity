...
export default function PublicLayout({ children, title, hideHeader, hideFooter, fullBleed }: PublicLayoutProps) {
    return (
        <div className="min-h-screen bg-gray-50">
            ...
            {/* Main Content */}
            <main className={fullBleed ? "w-full py-8" : "max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8"}>
                {children}
            </main>
